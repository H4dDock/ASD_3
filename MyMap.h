...
private:
    ...
    void ShowAsListHelper(Node<TKey,TValue> *node);
...
template<class TKey, class TValue>
void MyMap<TKey, TValue>::IncreamentValueByKey(TKey tkey) {
...
template<class TKey, class TValue>
void MyMap<TKey, TValue>::ShowAsList() {
    ShowAsListHelper(root);
}

template<class TKey, class TValue>
void MyMap<TKey, TValue>::ShowAsListHelper(Node<TKey, TValue> *node) {
    if(node != nullptr){
        ShowAsListHelper(node->leftSon);
